...
void Environment::initializeEnvironment(OpenglBuffersManager* openglBuffersManager, int explorerPheromoneIntensity, int nestCarrierPheromoneIntensity, int carrierPheromoneIntensity, int sensorAngle)
{
	/*
	...
	*/
	...
	Nests.push_back(new AntColony(100	, 0.0, 0.0, 10.0, 0, explorerPheromoneIntensity, nestCarrierPheromoneIntensity, carrierPheromoneIntensity, sensorAngle));
