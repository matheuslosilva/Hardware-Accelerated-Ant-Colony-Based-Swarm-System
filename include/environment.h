...
class Environment
{
	...
	public:
		...
		void initializeEnvironment(OpenglBuffersManager* openglBuffersManager, int explorerPheromoneIntensity, int nestCarrierPheromoneIntensity, int carrierPheromoneIntensity);
