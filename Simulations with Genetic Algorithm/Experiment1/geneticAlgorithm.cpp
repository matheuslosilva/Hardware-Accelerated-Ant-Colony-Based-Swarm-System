...
int main ()
{
	...
	for(int generation = 0; generation < MAX_GENERATIONS; generation++)
	{
		...
		myfile << population.individuals[bestIndex].getLattestFitnessScore() << endl;
		cout << population.individuals[bestIndex].getLattestFitnessScore() << endl;
		...
		for(int i = 0; i < (int) population.individuals.size(); i++)
		{
			if(i != bestIndex)
			{
				...
				myfile << population.individuals[i].getLattestFitnessScore() << endl;
				cout << population.individuals[i].getLattestFitnessScore() << endl;
			}
		}
