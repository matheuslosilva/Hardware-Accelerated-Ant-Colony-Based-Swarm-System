...
for i in range(0, (NUM_OF_PARAMETERS + 2) * POPULATION_SIZE * MAX_GENERATIONS, (NUM_OF_PARAMETERS + 2) * POPULATION_SIZE):
	...
	bestIndividualsVelocity.append(float(data[i + 1]))
	bestIndividualsFitness.append(float(data[i + NUM_OF_PARAMETERS + 1]))
...
x = [i for i in range(1, generations + 1)]
y = showdata[0]
plt.plot(x, y, c = "#069AF3", linewidth = 3, label = "RedPheromoneIntensity")#, marker = 'o', markersize = 3)
plt.xlabel("Generations")
...
x = [i for i in range(1, generations + 1)]
y = showdata[1]
plt.plot(x, y, c = "#069AF3", linewidth = 3, label = "GreenPheromoneIntensity")#, marker = 'o', markersize = 3)
plt.xlabel("Generations")
...
x = [i for i in range(1, generations + 1)]
y = showdata[2]
plt.plot(x, y, c = "#069AF3", linewidth = 3, label = "TIMEOUT")#, marker = 'o', markersize = 3)
plt.xlabel("Generations")
plt.ylabel("TIMEOUT")
plt.xlim(0, generations + 1)
plt.ylim(0, 2000)
...
x = [i for i in range(1, generations + 1)]
y = showdata[3]
plt.plot(x, y, c = "#069AF3", linewidth = 3, label = "PHEROMONE_EVAPORATION")#, marker = 'o', markersize = 3)
plt.xlabel("Generations")
